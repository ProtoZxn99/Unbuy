    ...
    <div class="container">
        ...
        <form class="form-signin" action="<?php echo base_url(); ?>login/process" method="POST">
            ...
            <div class="login-wrap">
                <input type="text" class="form-control" placeholder="User Email" autofocus name="txt_user">
              ...
              <div class="modal-dialog">
                  <div class="modal-content">
                      ...
                      <div class="modal-body">
                          <p>Enter your birth date and e-mail address below to reset your password.</p>
                          Birth Date<input type="date" class="form-control" autofocus name="txt_bd" required>
                          Email<input type="text" name="emailreset" placeholder="Email" autocomplete="off" class="form-control placeholder-no-fix" required>
